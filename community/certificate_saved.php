        ...
        <div class="row">
            ...
            <div class="row ud-con">
                    ...
                    <div style="padding:100px;">
                        <center>
                        <h1 style="text-shadow:2px 2px 2px red,2px 2px 2px black;">Saved Successfully</h1>
                        <p>Click on <b>Manage Certificate</b> menu to manage all certificate.</p>    
                        <span>or</span>
                        <p>Do as you wish</p>  
                        <br>
                        <span>In 3 sec you wiil redirected to dashboard automatically.</span>
                        <?php	header("refresh:3;url=../community/com_dash.php"); ?>
                         </center>
                    </div>
                </div>
            </div>
