        ...
        <div class="row">
            ...
            <div class="row ud-con">
                    ...
                    <div style="padding:100px;">
                        <center>
                            <?php include'../process/MailUpdate.php' ?>
                        
                        <span>In 3 sec you wiil redirected to Manage Certificate dashboard automatically.</span>
                            <img class="ricon" src="../icon/random.gif">
                        <?php	header("refresh:3;url=../community/comp_manage_cert.php"); ?>
                         </center>
                    </div>
                </div>
            </div>
